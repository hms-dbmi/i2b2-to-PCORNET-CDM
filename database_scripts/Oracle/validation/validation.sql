...
delete FROM I2B2DEMODATA.OBSERVATION_FACT WHERE MODIFIER_CD='CUSTOM:OBSERVATION_VALID:';
...
delete FROM OBSERVATION_FACT WHERE MODIFIER_CD='CUSTOM:OBSERVATION_INVALID_REASON:';
...
delete FROM I2B2DEMODATA.OBSERVATION_FACT WHERE MODIFIER_CD='CUSTOM:HIGHLIGHT:';
...
*
*/
delete from I2B2DEMODATA.OBSERVATION_FACT where MODIFIER_CD='CUSTOM:PATIENT_VALID:';
...
UPDATE I2B2DEMODATA.OBSERVATION_FACT O1 SET TVAL_CHAR='-1' WHERE MODIFIER_CD='CUSTOM:PATIENT_VALID:' 
AND NOT EXISTS (select * FROM I2B2DEMODATA.OBSERVATION_FACT O2 where O1.CONCEPT_CD=O2.CONCEPT_CD AND O1.PATIENT_NUM=O2.PATIENT_NUM AND O2.MODIFIER_CD='CUSTOM:OBSERVATION_VALID:' AND O2.TVAL_CHAR='1');
