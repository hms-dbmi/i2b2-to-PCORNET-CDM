...
INTO MODIFIER_DIMENSION (MODIFIER_PATH, MODIFIER_CD, NAME_CHAR, SOURCESYSTEM_CD) VALUES 
('\HIGHLIGHT\', 'CUSTOM:HIGHLIGHT:', 'HIGHLIGHT', 'CTAKES_16TESTFILES')
SELECT * FROM dual;
...
C_DIMCODE, C_COMMENT, C_TOOLTIP, UPDATE_DATE, SOURCESYSTEM_CD, VALUETYPE_CD, I2B2_ID,
M_APPLIED_PATH, M_EXCLUSION_CD, C_PATH, C_SYMBOL) VALUES
(2,'\cTAKES Modifiers\HIGHLIGHT\',	'HIGHLIGHT', 'N', 'RA', 'CUSTOM:HIGHLIGHT:',
null, 'MODIFIER_CD', 'MODIFIER_DIMENSION', 'MODIFIER_PATH',	'T', 'LIKE',
'\HIGHLIGHT\', null, '\cTAKES Modifiers\HIGHLIGHT\', '04-DEC-2014', 'cTAKES_MODIFIERS', null, '20000',
'\PMS_DN\02 PMS Clinical Notes (cTAKES NLP)\01 SNOMED\%', null, '\cTAKES Modifiers\', 'HIGHLIGHT')
SELECT * FROM dual;
...
select 'CUSTOM:HIGHLIGHT:', 'T', OBSERVATION_BLOB,CONCEPT_CD,PATIENT_NUM,ENCOUNTER_NUM,INSTANCE_NUM,SOURCESYSTEM_CD,PROVIDER_ID from OBSERVATION_FACT where OBSERVATION_BLOB is not null and modifier_cd='CUSTOM:SENT:'
;
