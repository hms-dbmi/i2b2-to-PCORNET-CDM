...
Insert into SEARCHAPP.PLUGIN_MODULE (MODULE_SEQ,PLUGIN_SEQ,NAME,VERSION,ACTIVE,HAS_FORM,FORM_LINK,FORM_PAGE,MODULE_NAME,CATEGORY,PARAMS) values (31,1,'Scatter Plot with Linear Regression','.1','Y','N',null,'ScatterPlot','scatterPlot','DEFAULT','');
Insert into SEARCHAPP.PLUGIN_MODULE (MODULE_SEQ,PLUGIN_SEQ,NAME,VERSION,ACTIVE,HAS_FORM,FORM_LINK,FORM_PAGE,MODULE_NAME,CATEGORY,PARAMS) values (66,1,'PCA','.1','Y','N',null,'PCA','pca','DEFAULT','');
Insert into SEARCHAPP.PLUGIN_MODULE (MODULE_SEQ,PLUGIN_SEQ,NAME,VERSION,ACTIVE,HAS_FORM,FORM_LINK,FORM_PAGE,MODULE_NAME,CATEGORY,PARAMS) values (67,1,'Marker Selection','.1','Y','N',null,'MarkerSelection','markerSelection','DEFAULT','');
Insert into SEARCHAPP.PLUGIN_MODULE (MODULE_SEQ,PLUGIN_SEQ,NAME,VERSION,ACTIVE,HAS_FORM,FORM_LINK,FORM_PAGE,MODULE_NAME,CATEGORY,PARAMS) values (21,1,'Line Graph','.1','Y','N',null,'LineGraph','lineGraph','DEFAULT','');
Insert into SEARCHAPP.PLUGIN_MODULE (MODULE_SEQ,PLUGIN_SEQ,NAME,VERSION,ACTIVE,HAS_FORM,FORM_LINK,FORM_PAGE,MODULE_NAME,CATEGORY,PARAMS) values (22,1,'Correlation Analysis','.1','Y','N',null,'CorrelationAnalysis','correlationAnalysis','DEFAULT','');
Insert into SEARCHAPP.PLUGIN_MODULE (MODULE_SEQ,PLUGIN_SEQ,NAME,VERSION,ACTIVE,HAS_FORM,FORM_LINK,FORM_PAGE,MODULE_NAME,CATEGORY,PARAMS) values (62,1,'Hierarchical Clustering','.1','Y','N',null,'HClust','hclust','DEFAULT','');
Insert into SEARCHAPP.PLUGIN_MODULE (MODULE_SEQ,PLUGIN_SEQ,NAME,VERSION,ACTIVE,HAS_FORM,FORM_LINK,FORM_PAGE,MODULE_NAME,CATEGORY,PARAMS) values (33,1,'Heatmap','.1','Y','N',null,'Heatmap','heatmap','DEFAULT','');
Insert into SEARCHAPP.PLUGIN_MODULE (MODULE_SEQ,PLUGIN_SEQ,NAME,VERSION,ACTIVE,HAS_FORM,FORM_LINK,FORM_PAGE,MODULE_NAME,CATEGORY,PARAMS) values (3,1,'Box Plot with ANOVA','.1','Y','N',null,'BoxPlot','boxPlot','DEFAULT','');
Insert into SEARCHAPP.PLUGIN_MODULE (MODULE_SEQ,PLUGIN_SEQ,NAME,VERSION,ACTIVE,HAS_FORM,FORM_LINK,FORM_PAGE,MODULE_NAME,CATEGORY,PARAMS) values (1,1,'Survival Analysis','.1','Y','N',null,'SurvivalAnalysis','survivalAnalysis','DEFAULT','');
Insert into SEARCHAPP.PLUGIN_MODULE (MODULE_SEQ,PLUGIN_SEQ,NAME,VERSION,ACTIVE,HAS_FORM,FORM_LINK,FORM_PAGE,MODULE_NAME,CATEGORY,PARAMS) values (32,1,'Table with Fisher Test','.1','Y','N',null,'TableWithFisher','tableWithFisher','DEFAULT','');
Insert into SEARCHAPP.PLUGIN_MODULE (MODULE_SEQ,PLUGIN_SEQ,NAME,VERSION,ACTIVE,HAS_FORM,FORM_LINK,FORM_PAGE,MODULE_NAME,CATEGORY,PARAMS) values (61,1,'K-Means Clustering','.1','Y','N',null,'KClust','kclust','DEFAULT','');
