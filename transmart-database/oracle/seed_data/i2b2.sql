...
--------------------------------------------------------
REM INSERTING into I2B2HIVE.CRC_ANALYSIS_JOB
SET DEFINE OFF;
REM INSERTING into I2B2HIVE.CRC_DB_LOOKUP
SET DEFINE OFF;
...
REM INSERTING into I2B2HIVE.HILOSEQUENCES
SET DEFINE OFF;
Insert into I2B2HIVE.HILOSEQUENCES (SEQUENCENAME,HIGHVALUES) values ('general',0);
REM INSERTING into I2B2HIVE.JMS_MESSAGES
SET DEFINE OFF;
...
REM INSERTING into I2B2HIVE.JMS_ROLES
SET DEFINE OFF;
...
REM INSERTING into I2B2HIVE.JMS_SUBSCRIPTIONS
SET DEFINE OFF;
REM INSERTING into I2B2HIVE.JMS_TRANSACTIONS
SET DEFINE OFF;
REM INSERTING into I2B2HIVE.JMS_USERS
SET DEFINE OFF;
...
REM INSERTING into I2B2HIVE.ONT_DB_LOOKUP
SET DEFINE OFF;
...
REM INSERTING into I2B2HIVE.TIMERS
SET DEFINE OFF;
...
REM INSERTING into I2B2HIVE.WORK_DB_LOOKUP
SET DEFINE OFF;
...
REM INSERTING into I2B2PM.PM_APPROVALS
SET DEFINE OFF;
REM INSERTING into I2B2PM.PM_APPROVALS_PARAMS
SET DEFINE OFF;
REM INSERTING into I2B2PM.PM_CELL_DATA
SET DEFINE OFF;
...
REM INSERTING into I2B2PM.PM_CELL_PARAMS
SET DEFINE OFF;
...
REM INSERTING into I2B2PM.PM_GLOBAL_PARAMS
SET DEFINE OFF;
REM INSERTING into I2B2PM.PM_HIVE_DATA
SET DEFINE OFF;
...
REM INSERTING into I2B2PM.PM_HIVE_PARAMS
SET DEFINE OFF;
REM INSERTING into I2B2PM.PM_PROJECT_DATA
SET DEFINE OFF;
...
REM INSERTING into I2B2PM.PM_PROJECT_PARAMS
SET DEFINE OFF;
REM INSERTING into I2B2PM.PM_PROJECT_REQUEST
SET DEFINE OFF;
REM INSERTING into I2B2PM.PM_PROJECT_USER_PARAMS
SET DEFINE OFF;
REM INSERTING into I2B2PM.PM_PROJECT_USER_ROLES
SET DEFINE OFF;
...
Insert into I2B2PM.PM_PROJECT_USER_ROLES (PROJECT_ID,USER_ID,USER_ROLE_CD,CHANGE_DATE,ENTRY_DATE,CHANGEBY_CHAR,STATUS_CD) values ('Demo','Demo','USER',null,null,null,'A');
REM INSERTING into I2B2PM.PM_ROLE_REQUIREMENT
SET DEFINE OFF;
...
REM INSERTING into I2B2PM.PM_USER_DATA
SET DEFINE OFF;
...
REM INSERTING into I2B2PM.PM_USER_PARAMS
SET DEFINE OFF;
REM INSERTING into I2B2SAMPLEDATA.I2B2_SAMPLE
SET DEFINE OFF;
Insert into I2B2SAMPLEDATA.I2B2_SAMPLE (C_HLEVEL,C_FULLNAME,C_NAME,C_SYNONYM_CD,C_VISUALATTRIBUTES,C_TOTALNUM,C_BASECODE,C_FACTTABLECOLUMN,C_TABLENAME,C_COLUMNNAME,C_COLUMNDATATYPE,C_OPERATOR,C_DIMCODE,C_TOOLTIP,UPDATE_DATE,DOWNLOAD_DATE,IMPORT_DATE,SOURCESYSTEM_CD,VALUETYPE_CD,I2B2_SAMPLE_ID) values (-1,'\Sample Type\','Sample Type','N','FA ',0,null,'CONCEPT_CD','CONCEPT_DIMENSION','CONCEPT_PATH','T','LIKE','\Sample Type\','\Sample Type\',to_date('13-APR-11','DD-MON-RR'),to_date('13-APR-11','DD-MON-RR'),to_date('13-APR-11','DD-MON-RR'),'Sample Type',null,null);
Insert into I2B2SAMPLEDATA.I2B2_SAMPLE (C_HLEVEL,C_FULLNAME,C_NAME,C_SYNONYM_CD,C_VISUALATTRIBUTES,C_TOTALNUM,C_BASECODE,C_FACTTABLECOLUMN,C_TABLENAME,C_COLUMNNAME,C_COLUMNDATATYPE,C_OPERATOR,C_DIMCODE,C_TOOLTIP,UPDATE_DATE,DOWNLOAD_DATE,IMPORT_DATE,SOURCESYSTEM_CD,VALUETYPE_CD,I2B2_SAMPLE_ID) values (-1,'\Subject Information\','Subject Information','N','FA ',0,null,'CONCEPT_CD','CONCEPT_DIMENSION','CONCEPT_PATH','T','LIKE','\Subject Information\','\Subject Information\',to_date('13-APR-11','DD-MON-RR'),to_date('13-APR-11','DD-MON-RR'),to_date('13-APR-11','DD-MON-RR'),'Subject Information',null,null);
Insert into I2B2SAMPLEDATA.I2B2_SAMPLE (C_HLEVEL,C_FULLNAME,C_NAME,C_SYNONYM_CD,C_VISUALATTRIBUTES,C_TOTALNUM,C_BASECODE,C_FACTTABLECOLUMN,C_TABLENAME,C_COLUMNNAME,C_COLUMNDATATYPE,C_OPERATOR,C_DIMCODE,C_TOOLTIP,UPDATE_DATE,DOWNLOAD_DATE,IMPORT_DATE,SOURCESYSTEM_CD,VALUETYPE_CD,I2B2_SAMPLE_ID) values (-1,'\Pathology\','Pathology','N','FA ',0,null,'CONCEPT_CD','CONCEPT_DIMENSION','CONCEPT_PATH','T','LIKE','\Pathology\','\Pathology\',to_date('13-APR-11','DD-MON-RR'),to_date('13-APR-11','DD-MON-RR'),to_date('13-APR-11','DD-MON-RR'),'Pathology',null,null);
Insert into I2B2SAMPLEDATA.I2B2_SAMPLE (C_HLEVEL,C_FULLNAME,C_NAME,C_SYNONYM_CD,C_VISUALATTRIBUTES,C_TOTALNUM,C_BASECODE,C_FACTTABLECOLUMN,C_TABLENAME,C_COLUMNNAME,C_COLUMNDATATYPE,C_OPERATOR,C_DIMCODE,C_TOOLTIP,UPDATE_DATE,DOWNLOAD_DATE,IMPORT_DATE,SOURCESYSTEM_CD,VALUETYPE_CD,I2B2_SAMPLE_ID) values (-1,'\Treatment\','Treatment','N','FA ',0,null,'CONCEPT_CD','CONCEPT_DIMENSION','CONCEPT_PATH','T','LIKE','\Treatment\','\Treatment\',to_date('13-APR-11','DD-MON-RR'),to_date('13-APR-11','DD-MON-RR'),to_date('13-APR-11','DD-MON-RR'),'Treatment',null,null);
Insert into I2B2SAMPLEDATA.I2B2_SAMPLE (C_HLEVEL,C_FULLNAME,C_NAME,C_SYNONYM_CD,C_VISUALATTRIBUTES,C_TOTALNUM,C_BASECODE,C_FACTTABLECOLUMN,C_TABLENAME,C_COLUMNNAME,C_COLUMNDATATYPE,C_OPERATOR,C_DIMCODE,C_TOOLTIP,UPDATE_DATE,DOWNLOAD_DATE,IMPORT_DATE,SOURCESYSTEM_CD,VALUETYPE_CD,I2B2_SAMPLE_ID) values (-1,'\Source Organism\','Source Organism','N','FA ',0,null,'CONCEPT_CD','CONCEPT_DIMENSION','CONCEPT_PATH','T','LIKE','\Source Organism\','\Source Organism\',to_date('13-APR-11','DD-MON-RR'),to_date('13-APR-11','DD-MON-RR'),to_date('13-APR-11','DD-MON-RR'),'Source Organism',null,null);
Insert into I2B2SAMPLEDATA.I2B2_SAMPLE (C_HLEVEL,C_FULLNAME,C_NAME,C_SYNONYM_CD,C_VISUALATTRIBUTES,C_TOTALNUM,C_BASECODE,C_FACTTABLECOLUMN,C_TABLENAME,C_COLUMNNAME,C_COLUMNDATATYPE,C_OPERATOR,C_DIMCODE,C_TOOLTIP,UPDATE_DATE,DOWNLOAD_DATE,IMPORT_DATE,SOURCESYSTEM_CD,VALUETYPE_CD,I2B2_SAMPLE_ID) values (-1,'\Data Types\','Data Types','N','FA ',0,null,'CONCEPT_CD','CONCEPT_DIMENSION','CONCEPT_PATH','T','LIKE','\Data Types\','\Data Types\',to_date('13-APR-11','DD-MON-RR'),to_date('13-APR-11','DD-MON-RR'),to_date('13-APR-11','DD-MON-RR'),'Data Types',null,null);
REM INSERTING into I2B2SAMPLEDATA.TABLE_ACCESS
SET DEFINE OFF;
Insert into I2B2SAMPLEDATA.TABLE_ACCESS (C_TABLE_CD,C_TABLE_NAME,C_PROTECTED_ACCESS,C_HLEVEL,C_FULLNAME,C_NAME,C_SYNONYM_CD,C_VISUALATTRIBUTES,C_TOTALNUM,C_BASECODE,C_FACTTABLECOLUMN,C_DIMTABLENAME,C_COLUMNNAME,C_COLUMNDATATYPE,C_OPERATOR,C_DIMCODE,C_TOOLTIP,C_ENTRY_DATE,C_CHANGE_DATE,C_STATUS_CD) values ('Sample Type','i2b2_sample','N',0,'\Sample Type\','Sample Type','N','CA ',null,null,'concept_cd','concept_dimension','concept_path','T','LIKE','\Sample Type\','\Sample Type\',to_date('13-APR-11','DD-MON-RR'),to_date('13-APR-11','DD-MON-RR'),null);
Insert into I2B2SAMPLEDATA.TABLE_ACCESS (C_TABLE_CD,C_TABLE_NAME,C_PROTECTED_ACCESS,C_HLEVEL,C_FULLNAME,C_NAME,C_SYNONYM_CD,C_VISUALATTRIBUTES,C_TOTALNUM,C_BASECODE,C_FACTTABLECOLUMN,C_DIMTABLENAME,C_COLUMNNAME,C_COLUMNDATATYPE,C_OPERATOR,C_DIMCODE,C_TOOLTIP,C_ENTRY_DATE,C_CHANGE_DATE,C_STATUS_CD) values ('Subject Information','i2b2_sample','N',0,'\Subject Information\','Subject Information','N','CA ',null,null,'concept_cd','concept_dimension','concept_path','T','LIKE','\Subject Information\','\Subject Information\',to_date('13-APR-11','DD-MON-RR'),to_date('13-APR-11','DD-MON-RR'),null);
Insert into I2B2SAMPLEDATA.TABLE_ACCESS (C_TABLE_CD,C_TABLE_NAME,C_PROTECTED_ACCESS,C_HLEVEL,C_FULLNAME,C_NAME,C_SYNONYM_CD,C_VISUALATTRIBUTES,C_TOTALNUM,C_BASECODE,C_FACTTABLECOLUMN,C_DIMTABLENAME,C_COLUMNNAME,C_COLUMNDATATYPE,C_OPERATOR,C_DIMCODE,C_TOOLTIP,C_ENTRY_DATE,C_CHANGE_DATE,C_STATUS_CD) values ('Pathology','i2b2_sample','N',0,'\Pathology\','Pathology','N','CA ',null,null,'concept_cd','concept_dimension','concept_path','T','LIKE','\Pathology\','\Pathology\',to_date('13-APR-11','DD-MON-RR'),to_date('13-APR-11','DD-MON-RR'),null);
Insert into I2B2SAMPLEDATA.TABLE_ACCESS (C_TABLE_CD,C_TABLE_NAME,C_PROTECTED_ACCESS,C_HLEVEL,C_FULLNAME,C_NAME,C_SYNONYM_CD,C_VISUALATTRIBUTES,C_TOTALNUM,C_BASECODE,C_FACTTABLECOLUMN,C_DIMTABLENAME,C_COLUMNNAME,C_COLUMNDATATYPE,C_OPERATOR,C_DIMCODE,C_TOOLTIP,C_ENTRY_DATE,C_CHANGE_DATE,C_STATUS_CD) values ('Treatment','i2b2_sample','N',0,'\Treatment\','Treatment','N','CA ',null,null,'concept_cd','concept_dimension','concept_path','T','LIKE','\Treatment\','\Treatment\',to_date('13-APR-11','DD-MON-RR'),to_date('13-APR-11','DD-MON-RR'),null);
Insert into I2B2SAMPLEDATA.TABLE_ACCESS (C_TABLE_CD,C_TABLE_NAME,C_PROTECTED_ACCESS,C_HLEVEL,C_FULLNAME,C_NAME,C_SYNONYM_CD,C_VISUALATTRIBUTES,C_TOTALNUM,C_BASECODE,C_FACTTABLECOLUMN,C_DIMTABLENAME,C_COLUMNNAME,C_COLUMNDATATYPE,C_OPERATOR,C_DIMCODE,C_TOOLTIP,C_ENTRY_DATE,C_CHANGE_DATE,C_STATUS_CD) values ('Source Organism','i2b2_sample','N',0,'\Source Organism\','Source Organism','N','CA ',null,null,'concept_cd','concept_dimension','concept_path','T','LIKE','\Source Organism\','\Source Organism\',to_date('13-APR-11','DD-MON-RR'),to_date('13-APR-11','DD-MON-RR'),null);
Insert into I2B2SAMPLEDATA.TABLE_ACCESS (C_TABLE_CD,C_TABLE_NAME,C_PROTECTED_ACCESS,C_HLEVEL,C_FULLNAME,C_NAME,C_SYNONYM_CD,C_VISUALATTRIBUTES,C_TOTALNUM,C_BASECODE,C_FACTTABLECOLUMN,C_DIMTABLENAME,C_COLUMNNAME,C_COLUMNDATATYPE,C_OPERATOR,C_DIMCODE,C_TOOLTIP,C_ENTRY_DATE,C_CHANGE_DATE,C_STATUS_CD) values ('Data Types','i2b2_sample','N',0,'\Data Types\','Data Types','N','CA ',null,null,'concept_cd','concept_dimension','concept_path','T','LIKE','\Data Types\','\Data Types\',to_date('13-APR-11','DD-MON-RR'),to_date('13-APR-11','DD-MON-RR'),null);
REM INSERTING into I2B2WORKDATA.WORKPLACE
SET DEFINE OFF;
REM INSERTING into I2B2WORKDATA.WORKPLACE_ACCESS
SET DEFINE OFF;
...
REM INSERTING into I2B2DEMODATA.CRC_DB_LOOKUP
SET DEFINE OFF;
REM INSERTING into I2B2METADATA.ONT_DB_LOOKUP
SET DEFINE OFF;
REM INSERTING into I2B2METADATA.TABLE_ACCESS
SET DEFINE OFF;
