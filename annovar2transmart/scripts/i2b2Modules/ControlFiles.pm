...
sub generateMasterScripts
{
	...
	print patientMasterScript 'sqlldr tm_lz/tm_lz@ORCL control=../control_files/patientDimension.ctl log=../log_files/patient_dimension.log';
	...
	print conceptMasterScript 'sqlldr tm_lz/tm_lz@ORCL control=../control_files/conceptDimension.ctl log=../log_files/concept_dimension.log';
	...
	print factMasterScript 'sqlldr tm_lz/tm_lz@ORCL control=../control_files/observationFact.ctl log=../log_files/observation_fact.log';
	...
	print i2b2MasterScript 'sqlldr tm_lz/tm_lz@ORCL control=../control_files/i2b2.ctl log=../log_files/i2b2.log';
...
sub generateObservationFactControlFile
{
	...
	print observation_fact_control_file "OPTIONS(DIRECT=TRUE) load data\n";
